...
<head>
    ...
    <title>Parker Management Portal | Edit</title>
    <!-- Fonts -->
...
<div class="container mt-2">
    <div class="row">
        <div class="col-sm-12 pb-2 pe-2">
            <a class="btn btn-primary float-lg-end" href="{{ route('list') }}">Back to List</a>
        </div>
        <div class="col-lg-12">
            ...
            <form method="post" id="create_form" action="{{ route('update', $member->id) }}"
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="telephoneNo" placeholder="Enter telephone"
                           name="telephoneNo" required value="{{ old('telephoneNo', $member->telephoneNo) }}">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <div class="input-group joinedDate" id="datepicker">
                        <input type="text" class="form-control" id="joinedDate" name="joinedDate" required
                               value="{{ old('joinedDate', \Carbon\Carbon::parse($member->joinedDate)->format('m/d/Y')) }}">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="currentRoute" placeholder="Enter route"
                           name="currentRoute" required value="{{ old('currentRoute', $member->currentRoute) }}">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <textarea class="form-control" name="comment" id="comment" placeholder="Enter comments"
                              required>{{old('comment', $member->comment)}}</textarea>
